...
var _defineProperty__default = _interopDefault(_defineProperty), _extends__default = _interopDefault(_extends), _objectWithoutProperties__default = _interopDefault(_objectWithoutProperties), FocusTrap__default = _interopDefault(FocusTrap);
...
const ARROW_WIDTH = 30, Wrapper = react.forwardRef((_ref, ref) => {
  let {left: left, top: top, width: width} = _ref, props = _objectWithoutProperties__default.default(_ref, [ "left", "top", "width" ]);
...
}), WrapperInner = react.forwardRef((props, ref) => core.jsx("div", _extends__default.default({
  ref: ref,
  css: {
    position: "relative"
  }
