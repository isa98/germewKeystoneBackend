...
var _defineProperty = require("@babel/runtime/helpers/defineProperty"), _objectWithoutProperties = require("@babel/runtime/helpers/objectWithoutProperties"), core = require("@emotion/core"), fields = require("@arch-ui/fields"), input = require("@arch-ui/input"), React = require("react"), _extends = require("@babel/runtime/helpers/extends"), reactImage = require("react-image"), PropTypes = require("prop-types"), octiconsReact = require("@primer/octicons-react"), loading = require("@arch-ui/loading"), lozenge = require("@arch-ui/lozenge"), button = require("@arch-ui/button"), layout = require("@arch-ui/layout"), theme = require("@arch-ui/theme");
...
var _defineProperty__default = _interopDefault(_defineProperty), _objectWithoutProperties__default = _interopDefault(_objectWithoutProperties), _extends__default = _interopDefault(_extends), PropTypes__default = _interopDefault(PropTypes);
...
class FileField extends React.Component {
  constructor(props) {
    super(props), _defineProperty__default.default(this, "onCancel", () => {
    ...
    }), _defineProperty__default.default(this, "onChange", ({target: {validity: validity, files: [file]}}) => {
      if (!file) return;
...
const Wrapper = props => core.jsx("div", _extends__default.default({
...
}, props)), Content = props => core.jsx("div", _extends__default.default({
  css: {
    flex: 1,
    minWidth: 0
  }
}, props)), MetaInfo = props => core.jsx(lozenge.Lozenge, _extends__default.default({
  crop: "right"
  ...
  let {status: status = "default"} = _ref2, props = _objectWithoutProperties__default.default(_ref2, [ "status" ]);
