...
var _defineProperty = require("@babel/runtime/helpers/defineProperty"), _objectWithoutProperties = require("@babel/runtime/helpers/objectWithoutProperties"), core = require("@emotion/core"), React = require("react"), _extends = require("@babel/runtime/helpers/extends"), client = require("@apollo/client"), Select = require("@arch-ui/select"), reactSelect = require("react-select");
...
const initialItemsToLoad = 10, subsequentItemsToLoad = 50, Relationship = React.forwardRef(({data: data, loading: loading, value: value, refList: refList, canRead: canRead, isMulti: isMulti, search: search, autoFocus: autoFocus, serverErrors: serverErrors, onChange: onChange, htmlID: htmlID, setSearch: setSearch, selectProps: selectProps, fetchMore: fetchMore, isDisabled: isDisabled}, ref) => {
  ...
  return core.jsx(Select__default.default, _extends__default.default({
