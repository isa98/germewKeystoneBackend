...
class MongooseMongoIdInterface extends adapterMongoose.MongooseFieldAdapter {
  ...
  getQueryConditions(dbPath) {
    ...
    return _objectSpread(_objectSpread({}, this.equalityConditions(this.field.isPrimaryKey ? "_id" : dbPath, mongoose.Types.ObjectId)), this.inConditions(this.field.isPrimaryKey ? "_id" : dbPath, val => val ? mongoose.Types.ObjectId(val) : null));
  }
}
